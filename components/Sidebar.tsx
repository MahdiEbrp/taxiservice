...
import { FaCarSide, FaMoneyBillAlt, FaMoneyCheckAlt, FaWikipediaW } from 'react-icons/fa';
            ...
            <Box>
                <List dir={direction} sx={{ backgroundColor: 'transparent !important' }} >
                    {userSettings && session.status === 'authenticated' &&
                        ...
                        <SidebarItem item={{ icon: <FaMoneyBillAlt />, text: sidebar.payments, url: '/user/payments' }} />
                            <Divider />
                    ...
                    <SidebarItem item={{ icon: <FaWikipediaW />, text: sidebar.wiki, url: 'https://github.com/MahdiEbrp/taxiservice/wiki' }} />
